# AI Detective Academy 🕵️

🤖💥 **Master AI Literacy Through Gamified Learning**

## About This Project

A fully gamified interactive app that teaches AI literacy through points, levels, badges, and real scenarios:

- 🧠 **32 Machine Pathologies** - Understanding AI's personality disorders
- ⏰ **Knowledge Cutoff** - Why AI is frozen in time
- 🪙 **Tokens & Context Windows** - AI's attention span currency
- 🛡️ **Critical Safety Tips** - Prompt injection, privacy, and bias
- ✅ **F.A.C.T.S. Framework** - Your AI verification checklist
- 💥 **Real Disaster Stories** - Learning from actual AI failures
- 🎯 **Interactive Quiz** - Test your AI detective skills
...
- **4 Game Modes**:
  - 🎭 **Scenario Detective** - Read real AI outputs and identify pathologies
  - ⚡ **Speed Quiz** - Test knowledge under time pressure
  - ✅ **F.A.C.T.S. Training** - Learn the verification framework
  - 💥 **Real Disasters** - Study actual AI failures
...
- ⚖️ The $5,000 Legal Brief (fake citations in court, 2023)
- 🤖 Microsoft Tay's 24-Hour Meltdown (racist tweets, 2016)
- 📧 Amazon Hiring AI Bias (gender discrimination, 2018)
...
**Remember**: AI is powerful but NOT perfect. Stay curious, stay skeptical, stay safe! 🕵️
